...
import org.truffle.cs.mj.nodes.MJVariableNode.MJAddAssignLocalVariableNode;
import org.truffle.cs.mj.nodes.MJVariableNode.MJDivAssignLocalVariableNode;
import org.truffle.cs.mj.nodes.MJVariableNode.MJMulAssignLocalVariableNode;
import org.truffle.cs.mj.nodes.MJVariableNode.MJReadLocalVariableNode;
import org.truffle.cs.mj.nodes.MJVariableNode.MJRemAssignLocalVariableNode;
import org.truffle.cs.mj.nodes.MJVariableNode.MJSubAssignLocalVariableNode;
...
public final class MJVariableNodeFactory {
    ...
    @GeneratedBy(MJAddAssignLocalVariableNode.class)
    public static final class MJAddAssignLocalVariableNodeGen extends MJAddAssignLocalVariableNode {
        ...
        private MJAddAssignLocalVariableNodeGen(MJExpressionNode value, FrameSlot slot, TypeDescriptor type) {
            this.slot = slot;
            this.type = type;
            this.value_ = value;
        }
        ...
        public Object execute(VirtualFrame frameValue) {
            int state = state_;
            if ((state & 0b10) == 0 /* only-active execute(VirtualFrame, int) */ && state != 0  /* is-not execute(VirtualFrame, int) && execute(VirtualFrame, double) */) {
                return execute_int0(frameValue, state);
            } else if ((state & 0b1) == 0 /* only-active execute(VirtualFrame, double) */ && state != 0  /* is-not execute(VirtualFrame, int) && execute(VirtualFrame, double) */) {
        ...
        private Object execute_double1(VirtualFrame frameValue, int state) {
            ...
            assert (state & 0b10) != 0 /* is-active execute(VirtualFrame, double) */;
            assert (isDoubleVariable());
            return execute(frameValue, valueValue_);
        }
        ...
        private Object execute_generic2(VirtualFrame frameValue, int state) {
            ...
            if ((state & 0b10) != 0 /* is-active execute(VirtualFrame, double) */ && valueValue_ instanceof Double) {
                double valueValue__ = (double) valueValue_;
                assert (isDoubleVariable());
                return execute(frameValue, valueValue__);
            }
        ...
        private Object executeAndSpecialize(VirtualFrame frameValue, Object valueValue) {
            ...
            if (valueValue instanceof Double) {
                double valueValue_ = (double) valueValue;
                if ((isDoubleVariable())) {
                    this.state_ = state = state | 0b10 /* add-active execute(VirtualFrame, double) */;
                    return execute(frameValue, valueValue_);
                }
            }
            throw new UnsupportedSpecializationException(this, new Node[] {this.value_}, valueValue);
        ...
        public static MJAddAssignLocalVariableNode create(MJExpressionNode value, FrameSlot slot, TypeDescriptor type) {
            return new MJAddAssignLocalVariableNodeGen(value, slot, type);
        }

    }
    @GeneratedBy(MJSubAssignLocalVariableNode.class)
    public static final class MJSubAssignLocalVariableNodeGen extends MJSubAssignLocalVariableNode {
        ...
        private MJSubAssignLocalVariableNodeGen(MJExpressionNode value, FrameSlot slot, TypeDescriptor type) {
            this.slot = slot;
            this.type = type;
            this.value_ = value;
        }
        ...
        public static MJSubAssignLocalVariableNode create(MJExpressionNode value, FrameSlot slot, TypeDescriptor type) {
            return new MJSubAssignLocalVariableNodeGen(value, slot, type);
        }

    }
    @GeneratedBy(MJMulAssignLocalVariableNode.class)
    public static final class MJMulAssignLocalVariableNodeGen extends MJMulAssignLocalVariableNode {
        ...
        private MJMulAssignLocalVariableNodeGen(MJExpressionNode value, FrameSlot slot, TypeDescriptor type) {
            this.slot = slot;
            this.type = type;
            this.value_ = value;
        }
        ...
        public static MJMulAssignLocalVariableNode create(MJExpressionNode value, FrameSlot slot, TypeDescriptor type) {
            return new MJMulAssignLocalVariableNodeGen(value, slot, type);
        }

    }
    @GeneratedBy(MJDivAssignLocalVariableNode.class)
    public static final class MJDivAssignLocalVariableNodeGen extends MJDivAssignLocalVariableNode {
        ...
        private MJDivAssignLocalVariableNodeGen(MJExpressionNode value, FrameSlot slot, TypeDescriptor type) {
            this.slot = slot;
            this.type = type;
            this.value_ = value;
        }
        ...
        public static MJDivAssignLocalVariableNode create(MJExpressionNode value, FrameSlot slot, TypeDescriptor type) {
            return new MJDivAssignLocalVariableNodeGen(value, slot, type);
        }

    }
    @GeneratedBy(MJRemAssignLocalVariableNode.class)
    public static final class MJRemAssignLocalVariableNodeGen extends MJRemAssignLocalVariableNode {
        ...
        private MJRemAssignLocalVariableNodeGen(MJExpressionNode value, FrameSlot slot, TypeDescriptor type) {
            this.slot = slot;
            this.type = type;
            this.value_ = value;
        }
        ...
        public static MJRemAssignLocalVariableNode create(MJExpressionNode value, FrameSlot slot, TypeDescriptor type) {
            return new MJRemAssignLocalVariableNodeGen(value, slot, type);
        }
